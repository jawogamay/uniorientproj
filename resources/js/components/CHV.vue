                ...
                <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addNewLabel">ADD CHV SERIES</h5>
...
<script type="text/javascript">
    export default{
        ...
        headers: [
          ...
          { text: 'START CHV', value: 'startchv',sortable: !1},
        ...
        methods: {
            ...
            createStartCHV(){
                this.form.post('api/chv')
                .then((response)=>{
                  this.spinner = true;
                  Fire.$emit('createdStartCHV')
                  $('#addNew').modal('hide');
                  toast.fire({
                    type: 'success',
            ...
            getCHV(){
              axios.get('api/chv').then(({data}) => this.startchv = data)
            },
            createdStartCHV(){
              this.getCHV()
              Fire.$on('createdStartCHV',()=>{
                this.getCHV()
              })
            },
         /*   viewEmployee(item){
